    ...
    <div className="group relative flex flex-col overflow-hidden bg-white">
      <div className="relative aspect-square overflow-hidden bg-gray-50">
        ...
        {isOutOfStock && (
          <div className="absolute inset-0 bg-black/70 flex items-center justify-center">
            <span className="text-white font-light uppercase tracking-[0.2em] text-sm">Agotado</span>
          </div>
        )}
      </div>
      ...
      <div className="flex flex-1 flex-col p-6 bg-white">
        ...
        <div className="mt-auto">
          <div className="mb-4">
            {isOutOfStock ? (
              <span className="text-[10px] text-red-600/80 uppercase tracking-[0.2em] font-light">Sin stock</span>
            ) : (
              <span className="text-[10px] text-black/60 uppercase tracking-[0.2em] font-light">Stock disponible</span>
            )}
          </div>
          ...
          <div className="flex flex-col gap-3">
            <a
              ...
              className="w-full h-11 flex items-center justify-center gap-2 text-[10px] font-light uppercase tracking-[0.2em] border border-black/20 text-black hover:border-black/40 transition-all"
            >
              Ver Detalle
            </a>
            <button
              ...
              className={`w-full h-11 flex items-center justify-center gap-2 text-[10px] font-light uppercase tracking-[0.2em] transition-all ${
                isOutOfStock
